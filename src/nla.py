# Vendored verbatim from github.com/kitft/nla-inference (nla_inference.py), Apache-2.0.
# Provides NLAClient (activation verbalizer) + NLACritic (reconstructor). Part 1 uses
# NLAClient only. Do not edit locally — re-pull from upstream to update.
...
class NLAClient:
    ...
    def _sglang_generate(
        ...
        sp = {"temperature": 1.0, "max_new_tokens": 256,
